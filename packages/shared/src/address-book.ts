/**
 * Address book mapping from nimiq-watch
 * Source: https://github.com/sisou/nimiq-watch/blob/master/address-book.js
 *
 * Maps known Nimiq addresses to human-readable labels.
 */
export const ADDRESS_BOOK: Record<string, string> = {
  ...
  'NQ69 LK52 01U1 E4AM TN1E 8HKL Y5FL M90D UJX8': 'SurveysForNimiq',
  ...
  'NQ13 XAME QAMX 3302 13E3 ECXQ HU88 TM6R YKVK': 'KuCoin (old)',
  'NQ16 HP6H 5CHC QQMD 5BE3 AFCQ QUJ9 4451 NKSM': 'KuCoin (old)',
  'NQ27 B9ED 98G5 3VH7 FY8D BFP0 XNF4 BD8L TN4B': 'KuCoin Cold',
  'NQ68 HPHJ 8RQU F48M 7S3L RF6D JVAC N2J4 S8A7': 'KuCoin (old)',
  'NQ55 H5H1 2AG5 XGSC L5NE 8U5E GF24 15SB GFEM': 'KuCoin',
  ...
  'NQ77 62HQ 4T7X UBYA GCGP 7FBV 58YV D6UE LDSY': 'Mexc',
  'NQ41 SUNH AFBN 62GY 33D3 1MC3 MCP1 HEJM CXC2': 'Ascendex',
  'NQ60 S8EH 3NNG K591 C4U9 CJQ4 83RD 108N BC4L': 'Gate.io',
  ...
  // Community Members
  'NQ65 GS91 H8CS QFAN 1EVS UK3G X7PL L9N1 X4KC': 'Albermonte',
